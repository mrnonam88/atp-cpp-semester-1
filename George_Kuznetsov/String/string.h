...
class String {
  ...
  //Метод subtsr() - возвращает подстроку
  ...
  //'символ' == строка
  friend bool operator == (char symbol,
    const String & string);
  //"слово" == 'символ'
  friend bool operator == (const char * word,
    const String & string);
  ...
  //Оператор []
  //для не константных строк
  char & operator[](const size_t index) {
    return str[index];
  }
  //для константных строк
...
//строка + строка
String operator + (const String & first_string,
  const String & sec_string) {
